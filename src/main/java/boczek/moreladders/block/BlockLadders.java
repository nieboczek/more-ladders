...
public class BlockLadders {
    ...
    public static final Block IRON_LADDER = registerBlock("iron_ladder", new LadderBlock(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block CHAIN_LADDER = registerBlock("chain_ladder", new LadderBlock(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.CHAIN)));
    ...
    public static final Block GOLD_LADDER = registerBlock("gold_ladder", new LadderBlock(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.METAL)));
    public static final Block COPPER_LADDER = registerBlock("copper_ladder", new OxidizableLadder(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.COPPER), Oxidizable.OxidationLevel.UNAFFECTED));
    public static final Block EXPOSED_COPPER_LADDER = registerBlock("exposed_copper_ladder", new OxidizableLadder(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.COPPER), Oxidizable.OxidationLevel.EXPOSED));
    public static final Block WEATHERED_COPPER_LADDER = registerBlock("weathered_copper_ladder", new OxidizableLadder(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.COPPER), Oxidizable.OxidationLevel.WEATHERED));
    public static final Block OXIDIZED_COPPER_LADDER = registerBlock("oxidized_copper_ladder", new OxidizableLadder(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.COPPER), Oxidizable.OxidationLevel.OXIDIZED));
    public static final Block WAXED_COPPER_LADDER = registerBlock("waxed_copper_ladder", new OxidizableLadder(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.COPPER), Oxidizable.OxidationLevel.UNAFFECTED, true));
    public static final Block WAXED_EXPOSED_COPPER_LADDER = registerBlock("waxed_exposed_copper_ladder", new OxidizableLadder(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.COPPER), Oxidizable.OxidationLevel.EXPOSED, true));
    public static final Block WAXED_WEATHERED_COPPER_LADDER = registerBlock("waxed_weathered_copper_ladder", new OxidizableLadder(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.COPPER), Oxidizable.OxidationLevel.WEATHERED, true));
    public static final Block WAXED_OXIDIZED_COPPER_LADDER = registerBlock("waxed_oxidized_copper_ladder", new OxidizableLadder(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.COPPER), Oxidizable.OxidationLevel.OXIDIZED, true));
